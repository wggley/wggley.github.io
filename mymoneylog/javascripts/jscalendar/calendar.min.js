	...
	else
	{
		if(typeof el.navtype == "undefined"
				|| (el.navtype != 50 && (el.navtype == 0 || Math
						.abs(el.navtype) > 2))) Calendar.removeClass(el,
				"active");
...
Calendar.cellClick = function(el, ev)
{
	...
	if(typeof el.navtype == "undefined")
	{
		...
		if(!other_month && !cal.currentDateEl) cal
...
Calendar.prototype.create = function(_par)
{
	...
	if(this.showsTime)
	{
		...
		(function()
		{
			...
			cell.className = "time";
			cell.colSpan = 2;
			if(t12) AP = makeTimePart("ampm", pm ? "pm" : "am",
			[
					"am", "pm"
			]);
			else
...
Calendar.prototype._init = function(firstDayOfWeek, date)
{
	...
	var dates = this.multiple ? (this.datesCells =
	{}) : null;
	for( var i = 0; i < 6; ++i, row = row.nextSibling)
	{
				...
				.setDate(iday + 1))
		{
			...
			if(!cell.disabled)
			{
				...
				if(weekend.indexOf(wday.toString()) != -1) cell.className += cell.otherMonth ? " oweekend"
						: " weekend";
			}
		}
...
Calendar.prototype.showAtElement = function(el, opts)
{
	...
	if(Calendar.is_khtml) setTimeout(
			"Calendar.continuation_for_the_fucking_khtml_browser()", 10);
	else
...
Calendar.prototype.hideShowCovered = function()
{
	...
	function getVisib(obj)
	{
		...
		if(!value)
		{
			...
			{
				if(!Calendar.is_khtml) value = document.defaultView
						.getComputedStyle(obj, "").getPropertyValue(
								"visibility");
				else
					value = '';
			}
