Calendar.setup = function(params)
{
	...
	function onSelect(cal)
	{
		...
		if(update && p.inputField)
		{
			...
			if(typeof p.inputField.onchange == "function") p.inputField
					.onchange();
		}
		if(update && p.displayArea) p.displayArea.innerHTML = cal.date
				.print(p.daFormat);
	...
	if(params.flat != null)
	{
		if(typeof params.flat == "string") params.flat = document
				.getElementById(params.flat);
		if(!params.flat)
		{
	...
	triggerEl["on" + params.eventName] = function()
	{
		...
		if(!params.position) cal.showAtElement(params.button
				|| params.displayArea || params.inputField, params.align);
		else
